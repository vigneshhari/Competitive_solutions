...
func BFS( current string ,target string, graph map[string]map[string]bool   ) int {
	var queue [][]string
	...
	maxLength , possible := visited[target]
...
func main(){
	...
	fmt.Println(ladderLength("cet" , "ism" , wordlist))
